...
SECRET_KEY = '#o&dktzo%qof9(n%g^y8sh5#1&%_s6sd=l#2rub=y3$lt-mhz&'
...
with open(BASE_DIR + os.sep + 'rsa_1024_pri.pem') as f:
    RSA_PRIVATE_KEY = ''.join(f.readlines())
with open(BASE_DIR + os.sep + 'rsa_1024_pub.pem') as f:
